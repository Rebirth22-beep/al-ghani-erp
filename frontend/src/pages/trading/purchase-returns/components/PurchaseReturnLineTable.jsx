...
export function PurchaseReturnLineTable({ control, register, errors, setValue, watch }) {
  ...
  const addLine = () =>
    append({ product: null, product_id: '', return_qty: 1, unit: '', cost_rate_rupees: 0, cost_rate_paisas: 0, total_paisas: 0 })
    ...
    <div className="space-y-2">
      <div className="overflow-x-auto rounded-xl border border-gray-200">
        <table className="w-full text-sm">
          <thead>
            <tr>
              {['Product', 'Return Qty', 'Unit', 'Cost Rate (Rs)', 'Total (Rs)', ''].map((h) => (
