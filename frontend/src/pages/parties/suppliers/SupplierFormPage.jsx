...
import { useSupplier, useSupplierMutations } from './hooks/useSupplier'
...
export function SupplierFormPage() {
  ...
  const onSubmit = (data) => {
    ...
    if (isEdit) {
      update.mutate({ id, data: payload }, { onSuccess: () => navigate('/parties/suppliers') })
    } else {
      create.mutate(payload, { onSuccess: () => navigate('/parties/suppliers') })
    }
  }
  ...
  return (
    <AnimatedPage>
      <PageHeader
        ...
        actions={
          <Button variant="secondary" onClick={() => navigate('/parties/suppliers')}>
            Cancel
          </Button>
        }
      />
